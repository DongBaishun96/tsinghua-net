...
from net.tools.data_format import format_time, format_usage, username_valid, wireless_valid
from net.tsinghua_wifi import is_network_connection, connect_wlan
from net.tools.parameter import login_url, status_url, headers
